            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin/pesertadidik') ?>">Peserta Didik</a>
                        <h6 class="collapse-header">Data Pelajaran:</h6>
                        <a class="collapse-item" href="<?= base_url('admin/tahunakademik') ?>">Tahun Akademik</a>
                        <a class="collapse-item" href="<?= base_url('admin/matapelajaran') ?>">Mata Pelajaran</a>
